...
void Text::Setup()
{
	...
	*/
	...
	std::string fullPath = FILE_PATH + fontPath;
...
void Text::setPosandScale(GLfloat xPos, GLfloat yPos, GLfloat scaleSz)
{
	x = xPos;
	y = yPos;
	scale = scaleSz;
...
void Text::Draw()
{
	Shader* shader = RenderManager::defaultTextShader;
	...
	shader->use();
	//std::cout << "Text shader ID is: " << shader->ID << std::endl;
